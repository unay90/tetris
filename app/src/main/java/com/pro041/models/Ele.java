...
public class Ele extends Pieza {
	...
	public Ele(GameView gv, int lado) {
		gameView=gv;
		rosa=BitmapFactory.decodeResource(gameView.getResources(), R.drawable.rosa);
		rosa=redimensionarImagen(rosa, lado, lado);
	...
	public boolean puedoColocarInicio(Bitmap[][] arrayPiezas) {
		if(arrayPiezas[15][4]==null && arrayPiezas[14][4]==null && arrayPiezas[13][4]==null && arrayPiezas[13][5]==null){
			return true;
		}
		return false;
	}
	...
	public void colocarInicio(Bitmap[][] arrayPiezas) {
		...
		posBloque4[0]=13;
		posBloque4[1]=5;
		arrayPiezas[posBloque1[0]][posBloque1[1]]=rosa;
		arrayPiezas[posBloque2[0]][posBloque2[1]]=rosa;
		arrayPiezas[posBloque3[0]][posBloque3[1]]=rosa;
		arrayPiezas[posBloque4[0]][posBloque4[1]]=rosa;
	}
	...
	public void girarPieza(Bitmap[][] arrayPiezas) {
		...
		case 2:
			...
			break;
		case 3:
			arrayPiezas[posBloque2[0]-1][posBloque1[1]-1]=arrayPiezas[posBloque2[0]][posBloque2[1]];
			arrayPiezas[posBloque3[0]-2][posBloque3[1]-2]=arrayPiezas[posBloque3[0]][posBloque3[1]];
			arrayPiezas[posBloque4[0]-3][posBloque4[1]-1]=arrayPiezas[posBloque4[0]][posBloque4[1]];
			arrayPiezas[posBloque2[0]][posBloque2[1]]=null;
			arrayPiezas[posBloque3[0]][posBloque3[1]]=null;
	...
	public boolean puedoGirarPieza(Bitmap[][] arrayPiezas) {
		switch (pos) {
		case 1:
			if(posBloque4[0]+3<=15 && posBloque4[1]+1<=9 && arrayPiezas[posBloque2[0]+1][posBloque2[1]+1]==null
					&& arrayPiezas[posBloque3[0]+2][posBloque3[1]+2]==null && arrayPiezas[posBloque4[0]+3][posBloque4[1]+1]==null){
				return true;
			}
			break;
		case 2:
			if(posBloque4[0]+1<=15 && posBloque4[1]-3>=0 && arrayPiezas[posBloque2[0]+1][posBloque2[1]-1]==null
					&& arrayPiezas[posBloque3[0]+2][posBloque3[1]-2]==null && arrayPiezas[posBloque4[0]+1][posBloque4[1]-3]==null){
				return true;
			}
			break;
		case 3:
			if(posBloque4[0]-3>=1 && posBloque4[1]-1>=0 && arrayPiezas[posBloque2[0]-1][posBloque1[1]-1]==null
					&& arrayPiezas[posBloque3[0]-2][posBloque3[1]-2]==null && arrayPiezas[posBloque4[0]-3][posBloque4[1]-1]==null){
				return true;
			}
			break;
		case 4:
			if(posBloque4[0]-1>=1 && posBloque4[1]+3<=9 && arrayPiezas[posBloque2[0]-1][posBloque2[1]+1]==null
					&& arrayPiezas[posBloque3[0]-2][posBloque3[1]+2]==null && arrayPiezas[posBloque4[0]-1][posBloque4[1]+3]==null){
				return true;
			}
			break;
	...
	public boolean puedoMoverAbajo(Bitmap[][] arrayPiezas) {
		switch (pos) {
		case 1:
			if(posBloque4[0]>1 && arrayPiezas[posBloque4[0]-1][posBloque4[1]]==null && arrayPiezas[posBloque3[0]-1][posBloque3[1]]==null){
				return true;
			}
			break;
		case 2:
			if(posBloque1[0]>1 && arrayPiezas[posBloque1[0]-1][posBloque1[1]]==null
					&& arrayPiezas[posBloque2[0]-1][posBloque2[1]]==null && arrayPiezas[posBloque3[0]-1][posBloque3[1]]==null){
				return true;
			}
			break;
		case 3:
	...
	public boolean puedoMoverDer(Bitmap[][] arrayPiezas) {
		...
		case 2:
			...
			break;
		case 3:
			if(posBloque3[1]<9 && arrayPiezas[posBloque1[0]][posBloque1[1]+1]==null
	...
	public boolean puedoMoverIzq(Bitmap[][] arrayPiezas) {
		...
		case 1:
			...
			break;
		case 2:
			if(posBloque1[1]>0 && arrayPiezas[posBloque1[0]][posBloque1[1]-1]==null && arrayPiezas[posBloque4[0]][posBloque4[1]-1]==null){
				return true;
			}
			break;
		case 3:
			if(posBloque4[1]>0 && arrayPiezas[posBloque4[0]][posBloque4[1]-1]==null
					&& arrayPiezas[posBloque2[0]][posBloque2[1]-1]==null && arrayPiezas[posBloque1[0]][posBloque1[1]-1]==null){
				return true;
			}
			break;
		case 4:
			if(posBloque4[1]>0 && arrayPiezas[posBloque4[0]][posBloque4[1]-1]==null && arrayPiezas[posBloque3[0]][posBloque3[1]-1]==null){
				return true;
			}
			break;
		}
