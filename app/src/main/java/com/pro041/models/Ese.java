...
public class Ese extends Pieza {
	...
	private Bitmap verde;
	private int[] posBloque1, posBloque2, posBloque3, posBloque4;
	private int pos;
	
	public Ese(GameView gv, int lado) {
		gameView=gv;
		verde=BitmapFactory.decodeResource(gameView.getResources(), R.drawable.verde);
		verde=redimensionarImagen(verde, lado, lado);
	...
	public boolean puedoColocarInicio(Bitmap[][] arrayPiezas) {
		if(arrayPiezas[14][4]==null && arrayPiezas[14][5]==null && arrayPiezas[15][5]==null && arrayPiezas[15][6]==null){
			return true;
		}
		return false;
	}
	...
	public void colocarInicio(Bitmap[][] arrayPiezas) {
		...
		posBloque4[0]=15;
		posBloque4[1]=6;
		arrayPiezas[posBloque1[0]][posBloque1[1]]=verde;
		arrayPiezas[posBloque2[0]][posBloque2[1]]=verde;
		arrayPiezas[posBloque3[0]][posBloque3[1]]=verde;
		arrayPiezas[posBloque4[0]][posBloque4[1]]=verde;
	}
	...
	public boolean puedoGirarPieza(Bitmap[][] arrayPiezas) {
		switch (pos) {
		case 1:
			if(posBloque4[0]+1<=15 && posBloque3[0]-2>=0 && arrayPiezas[posBloque2[0]+1][posBloque2[1]-1]==null
					&& arrayPiezas[posBloque3[0]][posBloque3[1]-2]==null && arrayPiezas[posBloque4[0]+1][posBloque4[1]-3]==null){
				return true;
			}
			break;
		case 2:
			if(posBloque4[1]+3<=9 && arrayPiezas[posBloque2[0]-1][posBloque2[1]+1]==null
					&& arrayPiezas[posBloque3[0]][posBloque3[1]+2]==null && arrayPiezas[posBloque4[0]-1][posBloque4[1]+3]==null){
				return true;
			}
			break;
	...
	public boolean puedoMoverDer(Bitmap[][] arrayPiezas) {
		switch (pos) {
		case 1:
			if(posBloque4[1]<9 && arrayPiezas[posBloque2[0]][posBloque2[1]+1]==null && arrayPiezas[posBloque4[0]][posBloque4[1]+1]==null){
				return true;
			}
			break;
		case 2:
	...
	public boolean puedoMoverIzq(Bitmap[][] arrayPiezas) {
		switch (pos) {
		case 1:
			if(posBloque1[1]>0 && arrayPiezas[posBloque1[0]][posBloque1[1]-1]==null && arrayPiezas[posBloque3[0]][posBloque3[1]-1]==null){
				return true;
			}
			break;
		case 2:
			if(posBloque3[1]>0 && arrayPiezas[posBloque1[0]][posBloque1[1]-1]==null && arrayPiezas[posBloque3[0]][posBloque3[1]-1]==null
					&& arrayPiezas[posBloque4[0]][posBloque4[1]-1]==null){
				return true;
			}
			break;
